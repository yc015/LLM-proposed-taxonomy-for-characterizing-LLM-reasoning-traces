...
#SBATCH --job-name=FixAIME2425BORCoder
...
#SBATCH --output=/n/home04/yidachen/bash_output/coding/fixed_codebook_bor-llama3.3-coder-on-AIME2425-%j.log
...
base_folder="/n/home04/yidachen/reasoning_characteristics/training_logs/fixed_codebook_aime_24_25-vllm-bor" # "/n/home04/yidachen/reasoning_characteristics/training_logs/aime_24_25-bor"
...
batch_size=44  # Smaller batch size for BOR (used for accumulation and evaluation)
accumulation_size=44  # Number of samples to accumulate before attempting updates
