...
#SBATCH --job-name=BORTransfer
#SBATCH --gres=gpu:4
#SBATCH --time=0-20:00:00
#SBATCH --cpus-per-task=16
#SBATCH --partition seas_gpu
#SBATCH --mem=196GB
#SBATCH --output=/n/home04/yidachen/reasoning_characteristics/bash_output/transfer/bor-transfer-%j.log
...
averaged_eval_flag=""
num_reruns=5
refit_transfer_classifier="yes"
log_dir="/n/home04/yidachen/reasoning_characteristics/training_logs/bor-transfer"
checkpoint_dir="/n/home04/yidachen/reasoning_characteristics/coder_ckpt/bor-transfer"
...
echo "Running BOR transfer experiment"
echo "Dataset A: $dataset_a_path"
echo "Dataset B: $dataset_b_path"

python coder_bor_transfer_experiment.py \
