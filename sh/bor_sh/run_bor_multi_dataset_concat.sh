...
#SBATCH --job-name=BORMultiDataset
#SBATCH --gres=gpu:nvidia_a100-sxm4-80gb:4
#SBATCH --time=0-20:00:00
#SBATCH --cpus-per-task=8
#SBATCH --mem=196GB
#SBATCH --partition seas_gpu
#SBATCH --output=/n/home04/yidachen/reasoning_characteristics/bash_output/multi/bor-multidataset-%j.log
...
averaged_eval_flag=""
num_reruns=5
log_dir="/n/home04/yidachen/reasoning_characteristics/training_logs/bor-multidataset"
checkpoint_dir="/n/home04/yidachen/reasoning_characteristics/coder_ckpt/bor-multidataset"
...
echo "Running BOR multi-dataset concatenated training"
echo "Datasets: $dataset_paths"

python coder_bor_multi_dataset_concat_training.py \
