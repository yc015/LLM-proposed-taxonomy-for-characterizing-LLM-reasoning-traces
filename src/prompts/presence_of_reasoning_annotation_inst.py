...
# {Annotate the occurrence of reasoning behaviors in each OUTPUT following their definition in the reasoning taxonomy.}
# ### [Reasoning Behavior name 1]
# ### [Definition of this reasoning behavior; reasoning with the given output; which output shows this reasoning behavior (with a quote)]
...
Give meaningful and detailed reasoning behavior definitions (at least 100 words) and examples. You want to make sure a different expert can make the same annotation as you did using your reasoning taxonomy.
